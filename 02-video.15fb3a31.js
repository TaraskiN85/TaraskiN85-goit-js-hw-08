...
}})}(r,o)}},r._window.addEventListener("message",r._onMessage),"IFRAME"!==r.element.nodeName){var i=z(e,o);$(M(i),i,e).then(function(t){var n,o,i=G(t,e);return(// Overwrite element with the new iframe,
...
if(null!==e.getAttribute("data-vimeo-defer"))return;var t=z(e),r=M(t);$(r,t,e).then(function(t){return G(t,e)}).catch(n)}catch(e){n(e)}})}(),/**
